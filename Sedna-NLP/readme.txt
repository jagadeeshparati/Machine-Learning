...
A function is created which takes text and returns the person names mentioned in the text

The data in the combined dataframe is resampled weekly to show the weekly data performance.